...
function ModoEnvio() {
  ...
  function nueva() { setNombre(""); setTexto(""); setAnalisis(null); setEnvioId(null); setDepu(null); setLogs([]); setEstado(null); setEnviando(false); if (archivoRef.current) archivoRef.current.value = ""; }
